...
import os
#print(os.listdir("/Users/xiaochengshen/Desktop"))
...
df_train_30m = pd.read_csv('/Users/xiaochengshen/Desktop/train.csv', dtype=dtypes, skiprows=range(1,131886954), usecols=train_columns)
print('Load df_train_30m with [{}] seconds'.format(time.time() - start_time))

# Load testing df
start_time = time.time()
df_test = pd.read_csv('/Users/xiaochengshen/Downloads/test.csv', dtype=dtypes)
...
df_submit.to_csv('/Users/xiaochengshen/Desktop/random_forest_talking_data.csv', index=False)