# -*- coding: utf-8 -*-
"""
Created on Sun Apr 22 14:12:36 2018
...
def lgb_modelfit_nocv(params, dtrain, dvalid, predictors, target='target', objective='binary', metrics='auc',
    ...
    feature_importances_ = bst1.feature_importances_
    print("\nModel Report")
    print("n_estimators : ", n_estimators)
    print('importance :', feature_importances_[0:5])
...
for import_type in ['weight', 'gain', 'cover']:
    importance_dict['lightgbm-'+import_type] = bst.best_score_
...
X_train = pd.read_csv('G:/Courses/EE380L Data Mining/project/train.csv', nrows=100000, parse_dates=['click_time'])
...
importance_dict = {}
for import_type in ['weight', 'gain', 'cover']:
    importance_dict['xgBoost-'+import_type] = LGBMModel.feature_importances_
